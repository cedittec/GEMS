...
class CalculosService {
    ...
    def graficaEstadoFinancieroIndex(sitio)
    {
        Date fechaHoy = new Date();            
        def fechaAtras
    ...
    def graficaIndexCostosGlobales(sitio)
    {
        ...
        def i = 0;
         ...
         use (TimeCategory) {
                ...
                while(i<12)
                {
                    ...
                    Calendar cal = Calendar.getInstance();
                    cal.setTime(fechaTempActual);  
                    SimpleDateFormat format1 = new SimpleDateFormat("dd/MM/yyM");                    
                    String formatted = format1.format(cal.getTime());
...
//                println "mes de fecha actual: "+ fechaHoy
   ...
   //Dado una tupla viniente de siste de cog. se devuelve el costo q genero el consumo de energia de CFE de dicha tupla (registro)
    ...
    //***************************METODOS DE CALCULOS COSTOS GLOBALES*****************************************
    ...
    def graficaIndexEmisiones(sitio)
    {
        Date fechaHoy = new Date();            
        def fechaAtras
        def valoresXmes1=[12] //El primer arreglo para el primer conjunto de valores a graficar (este caso ahorro energias alternas)
    ...
    def graficaEnergiaTermicaEnergeticos(sitio)
    {
        Date fechaHoy = new Date();            
        def fechaAtras
        def valoresXmes1=[12] //El primer arreglo para el primer conjunto de valores a graficar (este caso ahorro energias alternas)
    ...
    def graficaEnergiaElectricaEnergeticos(sitio)
    {
        Date fechaHoy = new Date();            
        def fechaAtras
        def valoresXmes1=[12] //El primer arreglo para el primer conjunto de valores a graficar (este caso ahorro energias alternas)
   ...
   def graficaIndexEnergeticos(sitio)
    {
        Date fechaHoy = new Date();            
        def fechaAtras
        def valoresXmes1=[12] //El primer arreglo para el primer conjunto de valores a graficar (este caso ahorro energias alternas)
    ...
    def graficaCombustiblesEnergeticos(sitio)
    {
        Date fechaHoy = new Date();            
        def fechaAtras
        def valoresXmes1=[12] //El primer arreglo para el primer conjunto de valores a graficar (este caso ahorro energias alternas)
   ...
   def temperaturaSistemaCogeneracion(sitio, fechaActual, fechaMesAtras)
    ...
    //Devuelve un arreglo de 2, [0] suma total de combustible, [1] : suma total de energia*poder calorifico de Cogeneracion
