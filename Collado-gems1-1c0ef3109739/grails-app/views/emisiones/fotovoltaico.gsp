...
<html>
    <head>
        ...
        <title>Emisi&oacute;n Fotovoltaico</title>
    </head>
    <body>
                ...
                <div class = "col-sm-12">
                    <ol class="breadcrumb" style="padding-top:0px; padding-right:0px">
                        <li style="padding-top:6px"><i class="fa fa-dashboard"></i> <a href="${createLink(controller:'emisiones', action:'index')}"> Emisiones</a></li>
                            <li class="active" style="padding-top:6px"> Sistema Fotovoltaico</li>
                    ...
                    <div class="col-md-4">
                        <div class="circle-tile">
                            ...
                            <div class="circle-tile-content orange">
                                ...
                                <div id="emisionesPanel" class="circle-tile-number text-faded">

                                    <g:formatNumber number="${emisionPanel}" type="number" maxFractionDigits="3" /> lbs CO2
                                </div>
                                &nbsp;
                            </div>
                        </div>
                        ...
                        <div class="circle-tile">
                            ...
                            <div class="circle-tile-content yellow">
                                ...
                                <div id="reduccionEmisiones" class="circle-tile-number text-faded">
                                    ...
                                    <g:formatNumber number="${emisionFotovoltaico}" type="number" maxFractionDigits="3" /> lbs CO2
                                </div>
                                &nbsp;
                            </div>
                        </div>
        ...
        <g:jasperReport type="hidden" jasper="EmisionesFotovoltaico" format="PDF" name="PDF" action="createEmisionesFotovoltaico" controller="pdfUtil">           
            ...
            <input hidden name="emisionesPanel" id="idemisionesPanel" />
    ...
    <script src="${request.contextPath}/Flex/js/demo/emisionesFotovoltaico.js"></script>
