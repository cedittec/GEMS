...
class gsp_GEMS1_emisionesfotovoltaico_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/emisiones/fotovoltaico.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(18)
invokeTag('formatNumber','g',109,['number':(emisionPanel),'type':("number"),'maxFractionDigits':("3")],-1)
printHtmlPart(19)
invokeTag('formatNumber','g',128,['number':(emisionFotovoltaico),'type':("number"),'maxFractionDigits':("3")],-1)
printHtmlPart(20)
}
else {
printHtmlPart(2)
...
invokeTag('jasperReport','g',172,['type':("hidden"),'jasper':("EmisionesFotovoltaico"),'format':("PDF"),'name':("PDF"),'action':("createEmisionesFotovoltaico"),'controller':("pdfUtil")],2)
printHtmlPart(23)
expressionOut.print(request.contextPath)
printHtmlPart(24)
expressionOut.print(request.contextPath)
