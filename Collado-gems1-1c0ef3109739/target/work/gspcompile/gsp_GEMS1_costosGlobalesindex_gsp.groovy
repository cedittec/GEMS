...
class gsp_GEMS1_costosGlobalesindex_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/costosGlobales/index.gsp" }
public Object run() {
Writer out = getOut()
...
if(true && (numeroSitios > 0)) {
printHtmlPart(16)
invokeTag('formatNumber','g',91,['number':(costoEnergiaElectrica),'type':("number"),'maxFractionDigits':("3")],-1)
printHtmlPart(17)
expressionOut.print(createLink(controller:'CostosGlobales', action:'costoEnergiaElectrica'))
printHtmlPart(18)
invokeTag('formatNumber','g',113,['number':(costoEnergiaTermica),'type':("number"),'maxFractionDigits':("3")],-1)
printHtmlPart(19)
expressionOut.print(createLink(controller:'CostosGlobales', action:'costoEnergiaTermica'))
printHtmlPart(20)
invokeTag('formatNumber','g',133,['number':(costoCombustibles),'type':("number"),'maxFractionDigits':("3")],-1)
printHtmlPart(19)
expressionOut.print(createLink(controller:'CostosGlobales', action:'costoCombustibles'))
printHtmlPart(21)
}
else {
printHtmlPart(2)
...
invokeTag('jasperReport','g',184,['type':("hidden"),'jasper':("CostosGlobalesIndex"),'format':("PDF"),'name':("PDF"),'action':("createCostosGlobalesIndex"),'controller':("pdfUtil")],2)
printHtmlPart(24)
