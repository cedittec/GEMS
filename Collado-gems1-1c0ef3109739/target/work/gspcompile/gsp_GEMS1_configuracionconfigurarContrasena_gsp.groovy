...
class gsp_GEMS1_configuracionconfigurarContrasena_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/configuracion/configurarContrasena.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('form','g',71,['onsubmit':("return checkForm(this);"),'name':("Configuracion"),'action':("passwordMod")],2)
printHtmlPart(14)
})
