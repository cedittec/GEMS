        ...
        var DRPTemplate = '<div class="daterangepicker dropdown-menu">' +
                ...
                '<div class="ranges">' +
                  '<div class="range_inputs">' +
                    ...
                    '</div>' +
                    '<button id="comenzarPDF" class="' + this.applyClass + ' applyBtn" disabled="disabled" >PDF</button>&nbsp;' +
                    '<button class="' + this.cancelClass + ' cancelBtn">Consultar</button>' +
                  '</div>' +
                '</div>' +
              '</div>';
