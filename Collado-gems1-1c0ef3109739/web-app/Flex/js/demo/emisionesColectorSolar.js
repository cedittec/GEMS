        ...
        //hacer llamada a método para actualizar
            ...
            xmlhttp.onreadystatechange=function()
            {
                if (xmlhttp.readyState==4 && xmlhttp.status==200)
                {
                    ...
                    $("#emisionesCSolar").html(algo[1].innerHTML + " lbs CO2");
            ...
            xmlhttp.open("GET","actualizaColectorSolar?sitioId="+sitioId+"&fechaInicio="+fechaInicio+"&fechaFinal="+fechaFinal,true);
            xmlhttp.send();
    }
