$(document).ready(function() {
    $('#reportrangeinstante').daterangepicker({
            startDate: moment(),
            minDate: moment(),
            maxDate: moment(),
            dateLimit: {
        ...
        function(start, end) {
            ...
            $('#reportrangeinstante span').html(start.format('MMMM D, YYYY'));
        }
    );
    //Set the initial state of the picker label
    $('#reportrangeinstante span').html(moment().format('MMMM D, YYYY'));
});
...
$(document).ready(function() {
    ...
    $('#reportrangeperiodo').daterangepicker({
            ...
            ranges: {  
				'Este Bimestre': [moment().subtract('month', 1).startOf('month'), moment().endOf('month')],
    ...
    $('#reportrangeperiodo span').html(moment().subtract('month', 1).startOf('month').format('MMMM D, YYYY') + ' - ' + moment().endOf('month').format('MMMM D, YYYY'));
    
});

$(document).ready(function() {
	//Set the initial state of the picker label
    $('#reportrangeperiodoS').daterangepicker({
            startDate: moment().subtract('month', 1).startOf('month'),
            endDate: moment().endOf('month'),
            minDate: '01/01/2010',
            maxDate:  moment().endOf('month'),
        ...
        function(start, end) {
            console.log("Callback has been called!");
            $('#reportrangeperiodoS span').html(start.format('MMMM D, YYYY') + ' - ' + end.format('MMMM D, YYYY'));
        }
    );
	
    $('#reportrangeperiodoS span').html(moment().subtract('month', 1).startOf('month').format('MMMM D, YYYY') + ' - ' + moment().endOf('month').format('MMMM D, YYYY'));
...
Morris.Area({
    ...
    labels: ['E. Electrica', 'E. Termica', 'Combustibles'],
