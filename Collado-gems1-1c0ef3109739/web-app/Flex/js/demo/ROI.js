    ...
    function xmlRequest(start, end){
        //hacer llamada a método para actualizar
            ...
            xmlhttp.onreadystatechange=function()
            {
                ...
                {
                    $("#costoCombustibleCogeneracion").html("0.0");
                    ...
                    $("#costoCombustibleCogeneracion").html(algo[0].innerHTML + " $");
            ...
            xmlhttp.open("GET","actualizaReporteROI?sitioId="+sitioId+"&fechaInicio="+fechaInicio+"&fechaFinal="+fechaFinal,true);
            xmlhttp.send();
    }
...
$("#comenzarPDF").click(function(){
        ...
        $("#fechaFinPDF").val( now );               
         ...
         var txt = $("#costoCombustibleCogeneracion").html().replace("$","");        
